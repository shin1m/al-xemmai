...
t_transfer t_context::f_create_source()
{
...
void t_type_of<t_context>::f_define(t_extension* a_extension)
{
	t_define<t_context, t_object>(a_extension, L"Context")
		...
		(L"get_device", t_member<t_transfer (t_context::*)() const, &t_context::f_get_device>())
		...
		(L"get_booleanv", t_member<t_transfer (t_context::*)(ALenum) const, &t_context::f_get_booleanv>())
		(L"get_integerv", t_member<t_transfer (t_context::*)(ALenum) const, &t_context::f_get_integerv>())
		(L"get_floatv", t_member<t_transfer (t_context::*)(ALenum) const, &t_context::f_get_floatv>())
		(L"get_doublev", t_member<t_transfer (t_context::*)(ALenum) const, &t_context::f_get_doublev>())
		...
		(L"get_listener3f", t_member<t_transfer (t_context::*)(ALenum) const, &t_context::f_get_listener3f>())
		(L"get_listenerfv", t_member<t_transfer (t_context::*)(ALenum) const, &t_context::f_get_listenerfv>())
