...
std::vector<std::pair<t_root, t_rvalue>> t_library::f_define()
{
	...
	return t_define(this)
		...
		(L"BaseDevice"sv, static_cast<t_object*>(v_type_base_device))
		(L"Device"sv, static_cast<t_object*>(v_type_device))
		(L"CaptureDevice"sv, static_cast<t_object*>(v_type_capture_device))
		(L"Context"sv, static_cast<t_object*>(v_type_context))
		(L"Source"sv, static_cast<t_object*>(v_type_source))
