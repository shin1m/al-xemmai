...
void t_type_of<xemmaix::al::t_source>::f_define(t_extension* a_extension)
{
	...
	t_define<t_source, t_object>(a_extension, L"Source"sv)
		...
		(L"get3f"sv, t_member<t_scoped(t_source::*)(ALenum) const, &t_source::f_get3f>())
		(L"geti"sv, t_member<ALint(t_source::*)(ALenum) const, &t_source::f_geti>())
		(L"get3i"sv, t_member<t_scoped(t_source::*)(ALenum) const, &t_source::f_get3i>())
		...
		(L"get_buffer"sv, t_member<t_scoped(t_source::*)() const, &t_source::f_get_buffer>())
		(L"queue_buffer"sv, t_member<void(t_source::*)(t_buffer&), &t_source::f_queue_buffer>())
		(L"unqueue_buffer"sv, t_member<t_scoped(t_source::*)(), &t_source::f_unqueue_buffer>())
	;
}
