...
void t_type_of<xemmaix::al::t_source>::f_define(t_extension* a_extension)
{
	...
	t_define<t_source, t_object>(a_extension, L"Source")
		...
		(L"get3f", t_member<t_scoped(t_source::*)(ALenum) const, &t_source::f_get3f>())
		(L"geti", t_member<ALint(t_source::*)(ALenum) const, &t_source::f_geti>())
		(L"get3i", t_member<t_scoped(t_source::*)(ALenum) const, &t_source::f_get3i>())
		...
		(L"get_buffer", t_member<t_scoped(t_source::*)() const, &t_source::f_get_buffer>())
...
t_type* t_type_of<xemmaix::al::t_source>::f_derive(t_object* a_this)
{
	return nullptr;
}
...
void t_type_of<xemmaix::al::t_source>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
