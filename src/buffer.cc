...
t_type* t_type_of<xemmaix::al::t_buffer>::f_derive(t_object* a_this)
{
	return nullptr;
}
...
void t_type_of<xemmaix::al::t_buffer>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
