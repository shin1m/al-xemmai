...
void t_type_of<xemmaix::al::t_context>::f_define(t_extension* a_extension)
{
	t_define<t_context, t_object>(a_extension, L"Context"sv)
		...
		(L"get_device"sv, t_member<t_scoped (t_context::*)() const, &t_context::f_get_device>())
		...
		(L"get_booleanv"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_booleanv>())
		(L"get_integerv"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_integerv>())
		(L"get_floatv"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_floatv>())
		(L"get_doublev"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_doublev>())
		...
		(L"get_listener3f"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_listener3f>())
		(L"get_listenerfv"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_listenerfv>())
		(L"get_listeneri"sv, t_member<ALint (t_context::*)(ALenum) const, &t_context::f_get_listeneri>())
		(L"get_listener3i"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_listener3i>())
		(L"get_listeneriv"sv, t_member<t_scoped (t_context::*)(ALenum) const, &t_context::f_get_listeneriv>())
		(L"create_source"sv, t_member<t_scoped (t_context::*)(), &t_context::f_create_source>())
